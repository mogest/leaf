defmodule Leaf.Leave do
  ...
  balance in: a type that grants nothing and is only recorded is still one they may file. The dates
  asked about are what decides, not today, so a type stops being offered for the dates its
