...
Every person needs an opening balance per leave type at go-live, imported from existing
spreadsheets/payroll. Admins can also make manual balance adjustments at any time, with a
...
- Individual view of own leave and balances.
...
retrospective ones), manual balance adjustments, grants, expiries, accrual recalculations,
...
7. **History is editable.** Corrections are expected and the system recalculates rather than
   forcing admins into a spreadsheet.
